...
EOF
        ...
        if [[ "${USE_WIREGUARD:-n}" == "y" ]]; then
            ...
            # --- STRICT ZERO TRUST HIERARCHY (v10.00) - DEBIAN PARITY) ---
...
function generate_dashboard() {
    log "INFO" "Generating the Serverless Dashboard UI (Expanded v10.00)..."
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16 items-center">
                <div class="flex items-center gap-3">
                    ...
                    <h1 class="text-xl font-bold tracking-tight">SysWarden <span class="text-brand-500">v10.00</span></h1>
                </div>
...
if [[ "$MODE" != "update" ]]; then
    clear
    echo -e "${GREEN}#############################################################"
    echo -e "#     SysWarden Tool Installer (Universal v10.00)     #"
    echo -e "#############################################################${NC}"
fi
