...
EOF
        ...
        if [[ "${USE_WIREGUARD:-n}" == "y" ]]; then
            ...
            # --- STRICT ZERO TRUST HIERARCHY (v1.85) - DEBIAN PARITY) ---
...
# ==============================================================================
# SYSWARDEN v1.85 - TELEMETRY BACKEND (SERVERLESS - IP REGISTRY UPDATE)
# ==============================================================================
...
# ==============================================================================
# SYSWARDEN v1.85 - NGINX SECURE DASHBOARD (HTTPS / CSP / LOCAL FONTS / BENTO-DARK)
# ==============================================================================
...
if [[ "$MODE" != "update" ]]; then
    clear
    echo -e "${GREEN}#############################################################"
    echo -e "#     SysWarden Tool Installer (Universal v1.85)     #"
    echo -e "#############################################################${NC}"
fi
